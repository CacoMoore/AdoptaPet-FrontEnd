      ...
      <div className="accordion col-11" id="accordionExample">
        <div className="accordion-item">
          <h2 className="accordion-header">
            <button
              className="accordion-button text-light opacity-50  "
            ...
            >
              <div>
                <strong>Solicitud de adopción N° {props.id}</strong>{" "}
                &nbsp;Usuario <strong>{props.user}</strong>
              </div>
            </button>
          </h2>
            ...
            <div className="accordion-body">
              ...
              <ul style={{ listStyle: "none" }}>
                <li className="fw-semibold">
                  1. Indica el animal que le interesa y por qué busca adoptar
                ...
                <li className="fw-semibold">
                  9. ¿Ha tenido un animalito? Cuéntenos su experiencia
                  (indicando especie, sexo, raza, edad, cómo llegó, cómo
                  falleció)
                  <ul className="fw-normal">{props.query9}</ul>
                </li>
                <li className="fw-semibold">
                  10. ¿Tiene otros animales actualmente en casa? Cuéntenos algo
                  de ellos: cuántos son, qué relación tiene con ellos, dónde los
                  obtuvo, etc.
                ...
                <li className="fw-semibold">
                  14. ¿Qué opina sobre las familias que tienen dentro de la casa
                  a sus animales y duermen con ellos?
                ...
                <li className="fw-semibold">
                  16. Según la especie que desee adoptar ¿conoces las vacunas
                  que necesita?
                  <ul className="fw-normal">{props.query16}</ul>
                </li>
                <li className="fw-semibold">
                  17. Nuestros animales son rescatados de abandono, muchas veces
                  no se conoce a los padres. En caso de querer adoptar perro,
                  ¿qué pasaría si el tamaño definitivo no era el que usted
                  esperaba cuando sea adulto?
                ...
                <li className="fw-semibold">
                  33. Si es soltero y vives solo, ¿qué harías si a tu pareja no
                  le gusta su animal de compañía?
                ...
                <li className="fw-semibold">
                  42. Supongamos. Si es extranjero, ¿qué pasaría con el animal
                  si regresa a su país? (O si es chileno, y se fuese a vivir al
                  extranjero)
