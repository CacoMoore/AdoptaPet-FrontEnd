            ...
            <div className="row g-5">
                ...
                <div className="col-md-7 col-lg-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="needs-validation" novalidate="">
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">1. Indica el animal que le interesa y por qué busca  adoptar</label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">16. Según la especie que desee adoptar ¿conoces las vacunas que necesita? </label>
                            <div className="">
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="no"{...register('query16')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">NO </label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="si"{...register('query16')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">SI </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">18. ¿Cuenta con vehículo?  </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">20. ¿Cuenta su gatito con su examen retroviral negativo? </label>
                            <div className="">
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="no"{...register('query20')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">NO, no he realizado el examen o su examen retroviral es positivo </label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="si"{...register('query20')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">SI, cuenta con su examen retroviral negativo </label>
                                </div>
                            </div>
                        </div>

                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">21. ¿Esta vacunado contra la leucemia su gatito?</label>
                            <div className="">
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="no"{...register('query21')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">NO, no esta vacunado contra la leucemia </label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="si"{...register('query21')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">SI, esta vacunado contra la leucemia </label>
                                </div>
                            </div>
                        </div>

                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">22. ¿Su gatito es indoor o outdoor?</label>
                            <div className="">
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="Indoor"{...register('query22')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">Indoor (vive solo al interior del hogar) </label>
                                </div>
                                <div className="form-check">
                                    <input className="form-check-input" type="radio" id="" value="Outdoor"{...register('query22')} />
                                    <label className="form-check-label" htmlFor="flexCheckDefault">Outdoor (vive en el interior y también sale a la calle) </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">26. ¿Están bien cerrados los límites de vivienda a la calle? </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">27. En caso de departamento, tiene mallas de seguridad? </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">30. ¿Existe la posibilidad de una mudanza próximamente? </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">36. ¿Hay personas con alergias en su familia? </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">37. ¿Trabaja actualmente? </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">38. ¿Tiene estabilidad Laboral?  </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">43. ¿Cuenta con la solvencia económica para seguir con  una alimentación súper premium para su animalito adoptado?  </label>
                            <div className="">
                                <div className="form-check">
                        ...
                        <div className="mb-4">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label fw-semibold">44. ¿Esta de acuerdo con las condiciones  para adoptar y su seguimiento?</label>
                            <div className="">
                                <div className="form-check">
