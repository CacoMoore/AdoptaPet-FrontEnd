                ...
                <div className="card mb-3" >
                    <div className="row g-0">
                        <div className="col-md-4">
                            <img /*props.blogimage*/ src="https://www.purina-latam.com/sites/default/files/styles/social_share_large/public/purina-gatos%20en%20adopcion-que-es-mejor-gatitos-bebes-o-gatos-adultos.jpg?itok=IqRKD1Zt" className="img-fluid rounded-start" alt="..." />
                        </div>
