...
const Adopform = (props) => {
  ...
  useEffect(() => {
    actions.getForm().then((data) => setFormresponse(data));
  }, [actions]);
    ...
    <>
      <div className="container">
        <div className="py-5 text-center">
          ...
          <p className="lead">
            A continuación podras ver las solicitudes de adopción con todos los
            campos requeridos en el formulario que se ofrece a los usuarios.
            También podrás borrar de la base de datos aquellas solicitudes que
            ya no se encuentren vigentes.
          </p>

          <p className="lead">
            <strong>IMPORTANTE:</strong> Haz click en el ícono para borrar una
            solictud. Una vez que la borres, esta no se podrá recuperar. El
            usuario tendrá que volver a rellenar el formulario.
          </p>
        </div>
