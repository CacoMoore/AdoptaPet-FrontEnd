...
const AddDescription = () => {
  ...
  return (
    <div style={{ borderRadius: "5px", minHeight: "100vh" }}>
      <div style={{ borderRadius: "5px" }} className="shadow-lg m-4 p-2">
        <ul
          className="nav nav-pills justify-content-center m-1"
          id="pills-tab"
          role="tablist"
        >
          <li className="nav-item" role="presentation">
            <button
              className="btn btn-lg btn-light active m-2"
              id="pills-home-tab"
              data-bs-toggle="pill"
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <div className="m-5">
              ...
              <form id="description" onSubmit={actions.handleUserDescription}>
                ...
                <div className="form-outline mb-4">
                  ...
                  <label className="form-label" htmlFor="motivation">
                    ¿Cuál es tu motivación para adoptar?
                  </label>
                </div>
                <div className="form-outline mb-4">
                  <input
                  ...
                  <label className="form-label" htmlFor="style">
                    Háblanos del lugar donde vives, ¿Tienes espacio para una
                    mascota?
                  </label>
                </div>
          ...
          >
            <div className="m-5">
              ...
              <form onSubmit={actions.putUserInfo} id="info">
                <div className="form-outline mb-4 mt-5">
                  <input
