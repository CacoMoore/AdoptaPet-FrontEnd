        ...
        <div className="row d-flex  row-singlePet">
          ...
          <div className="col-md-6 column-mt ">
            ...
            <div className="d-flex justify-content-center">
              <Link
                ...
                to="/adopform"
                type="button"
                class="btn btn-lg text-light mt-5 me-3"
              >
                Adoptar
              </Link>
              <button
                ...
                type="button"
                class="btn btn-lg bg-danger text-light mt-5 me-3"
              >
                Favorito
              </button>
              ...
              {rol_id === 1 ? (
                <>
                  <button
                    onClick={() => deletePetId()}
                    type="button"
                    class="btn btn-dark btn-lg mt-5 me-3"
                  >
                    Eliminar
                  </button>
                  <Link to={`/pex/${id}`}>
          ...
          <div className="col-md-6 ps-5">
            ...
            <div className="mb-3 ">
              ...
              <span className="ms-3  fs-5">{petGet.name}</span>
            </div>
            <div className="mb-3 ">
              <span className="fs-4">Genero:</span>
              <span className="ms-3  fs-5">{petGet.gender}</span>
            </div>
            <div className="mb-3 ">
              <span className="fs-4">Edad:</span>
              <span className="ms-3  fs-5">{petGet.age}</span>
            </div>
            <div className="mb-3 ">
              <span className="fs-4">Especie:</span>
              <span className="ms-3  fs-5">{petGet.species}</span>
            </div>
            <div className="mb-3 ">
              <span className="fs-4">Tamaño:</span>
              <span className="ms-3  fs-5">{petGet.size}</span>
            </div>
            <div className="mb-3 ">
              <span className="fs-4">Historial medico:</span>
              <span className="ms-3  fs-5">{petGet.medical_history}</span>
            </div>
            <div className="mb-3 ">
              <span className="fs-4">Descripción:</span>
              <span className="ms-3  fs-5">{petGet.description}</span>
            </div>
            {/**/}
            <div className="mb-3 ">
              <span className="fs-4">Disponibilidad:</span>
